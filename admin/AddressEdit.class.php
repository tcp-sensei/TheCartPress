...
class TCPAddressEdit {
	...
	function show( $echo = true ) {
		...
		if ( is_admin() ) {
			$admin_path = TCP_ADMIN_PATH . 'AddressesList.php';
		} else {
...
<form method="post" class="form">
	...
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'address_name' ); ?>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'firstname' ); ?>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'lastname' ); ?>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e( 'This id is useful to connect the customers with third software', 'tcp' ); ?></span>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<?php //$this->tcp_show_error_msg( $error_address, 'company' ); ?>
		</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e( 'This id is useful to connect the companies with third software', 'tcp' ); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'country_id' ); ?>
		</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'postcode' ); ?>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'telephone_1' ); ?>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'telephone_2' ); ?>
		</td>
	</tr>
		<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'fax' ); ?>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<?php $this->tcp_show_error_msg( $error_address, 'email' ); ?>
		</td>
	</tr>
		<tr valign="top">
	...
	function tcp_show_error_msg( $error_array, $id ) {
		if ( isset( $error_array[$id][0] ) ) {
			echo '<span class="tcp_error">', $error_array[$id][0], '</span>';
		}
	}
